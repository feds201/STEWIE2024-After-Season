...
public class ShootFromHandoffReverse extends SequentialCommandGroup {
    /**
    ...
    public ShootFromHandoffReverse(ShooterRotation shooterRotation, ShooterWheels shooterWheels,
        ...
        addCommands(
            ...
            new ShootNoteAtSpeakerOnlyReverse(shooterRotation, shooterWheels, servos, leds, distanceSupplier, shooterIRSensor),
